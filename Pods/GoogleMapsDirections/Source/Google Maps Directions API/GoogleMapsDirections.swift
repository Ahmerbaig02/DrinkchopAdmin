        ...
        completion: ((_ response: Response?, _ error: NSError?) -> Void)? = nil)
    {
        ...
        let request = Alamofire.request(baseURLString, method: .get, parameters: requestParameters).responseJSON { response in
            ...
            case .none:
                ...
                error = NSError(domain: "GoogleMapsDirectionsError", code: -4, userInfo: userInfo as? [String : Any])
            case .some(let status):
                ...
                case .notFound:
                    ...
                    error = NSError(domain: "GoogleMapsDirectionsError", code: -5, userInfo: userInfo as? [String : Any])
                case .zeroResults:
                    let userInfo: [AnyHashable: Any] = [
                    ...
                    error = NSError(domain: "GoogleMapsDirectionsError", code: -6, userInfo: userInfo as? [String : Any])
                case .maxWaypointsExceeded:
                    ...
                    error = NSError(domain: "GoogleMapsDirectionsError", code: -7, userInfo: userInfo as? [String : Any])
                case .invalidRequest:
                    let userInfo: [AnyHashable: Any] = [
                    ...
                    error = NSError(domain: "GoogleMapsDirectionsError", code: -8, userInfo: userInfo as? [String : Any])
                case .overQueryLimit:
                    let userInfo: [AnyHashable: Any] = [
                    ...
                    error = NSError(domain: "GoogleMapsDirectionsError", code: -9, userInfo: userInfo as? [String : Any])
                case .requestDenied:
                    let userInfo: [AnyHashable: Any] = [
                    ...
                    error = NSError(domain: "GoogleMapsDirectionsError", code: -10, userInfo: userInfo as? [String : Any])
                case .unknownError:
                    let userInfo: [AnyHashable: Any] = [
                    ...
                    error = NSError(domain: "GoogleMapsDirectionsError", code: -11, userInfo: userInfo as? [String : Any])
                }
            }
