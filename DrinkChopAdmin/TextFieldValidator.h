 ...
 */
#define IconImageName @"ic_error_outline_18pt"
 ...
 */
#define MsgValidateLength @"Don't leave this field blank"
...
-(void)addDistinctValidationTo:(NSString *)txtPassword withMsg:(NSString *)msg;
